        ...
        voiceInput={({ history }) => (
          <div className="flex w-full max-w-md flex-col items-center space-y-7 p-6">
            ...
            <div className="flex w-full items-center justify-center py-16">
              <p className="text-gray-500">음성 인식 준비중...</p>
            </div>

            <button
              onClick={() => history.push('selectInputMethod', {} as Record<string, never>)}
              className="w-full rounded-lg bg-gray-200 py-3 text-center font-medium transition-colors hover:bg-gray-300"
            >
              뒤로 가기
            </button>
          </div>
        )}
        confirmation={({ context, history }) => (
          <div className="flex w-full max-w-md flex-col items-center space-y-7 p-6">
            <div className="relative mb-4 h-50 w-50">
